...
cmd="python /cellar/users/aklie/opt/deeptopic/scripts/annotate/motif_enrichment.py \
    --foreground ${BED} \
    --background /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/endocrine/binarized/consensus_regions.bed \
    --subtract_foreground \
    --max_background auto \
    --genome /cellar/users/aklie/data/ref/genomes/hg38/hg38.fa \
    --output_dir /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/endocrine/annotated/motifs/${NAME} \

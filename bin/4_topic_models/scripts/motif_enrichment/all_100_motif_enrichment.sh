...
# Submit: cpu_array.sh -s <this>.sh -j motif_enrich_100 -m 8G -t 04:00:00 -c 4 -n 100 -x 10
...
cmd="python /cellar/users/aklie/opt/deeptopic/scripts/annotate/motif_enrichment.py \
    --foreground ${BED} \
    --background /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/all/n100/binarized/consensus_regions.bed \
    --subtract_foreground \
    --max_background auto \
    --genome /cellar/users/aklie/data/ref/genomes/hg38/hg38.fa \
    --output_dir /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/all/n100/annotated/motifs/${NAME} \

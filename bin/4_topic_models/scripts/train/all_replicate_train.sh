...
cmd="python /cellar/users/aklie/opt/deeptopic/scripts/crested/train_topic_model.py \
    ...
    --regions_file /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/all_replicate/binarized/consensus_regions.bed \
    --genome /cellar/users/aklie/data/ref/genomes/hg38/hg38.fa \
    --output_dir /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/all_replicate/crested_model \
    --project_name sc-islet-differentiation_10X-Multiome_all_replicate \
    "
echo -e "Running:\n$cmd\n"
eval $cmd

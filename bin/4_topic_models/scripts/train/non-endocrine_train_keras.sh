...
cmd="python /cellar/users/aklie/opt/deeptopic/scripts/crested/train_topic_model.py \
    --beds_dir /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/non-endocrine/binarized/beds \
    --regions_file /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/non-endocrine/binarized/consensus_regions.bed \
    --genome /cellar/users/aklie/data/ref/genomes/hg38/hg38.fa \
    --output_dir /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/non-endocrine/crested_model \
    --project_name sc-islet-differentiation_10X-Multiome_non-endocrine \
    --backend tensorflow"
echo -e "Running:\n$cmd\n"
eval $cmd

...
cmd="python /cellar/users/aklie/opt/deeptopic/scripts/pycistopic/run_models.py \
    --input /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/non-endocrine/objects/sc-islet-differentiation_10X-Multiome_non-endocrine.pkl \
    --output /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_topic_models/non-endocrine/models_mallet/topic_${topic} \
    --n_topics $topic \
    --method mallet \
    --n_cpu 8 \
    --n_iter 150 \

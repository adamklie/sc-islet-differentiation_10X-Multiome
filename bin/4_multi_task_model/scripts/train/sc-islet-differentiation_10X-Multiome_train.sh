...
#####
# Script to train a CREsted peak regression base model
# USAGE: sbatch \
#--job-name=crested_train \
...
# Run cmd
cmd="python /cellar/users/aklie/opt/crested/scripts/train_peak_regression.py \
...
--output_dir /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_multi_task_model/crested/basemodel \

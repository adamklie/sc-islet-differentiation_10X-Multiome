...
bias_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_early_others/fold_0/chrombpnet/0.5/predictions/D45_early_others_bias.bw
)
chrombpnet_nobias_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_early_others/fold_0/chrombpnet/0.5/predictions/D45_early_others_chrombpnet_nobias.bw
)
chrombpnet_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_early_others/fold_0/chrombpnet/0.5/predictions/D45_early_others_chrombpnet.bw
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_early_others/average/predictions

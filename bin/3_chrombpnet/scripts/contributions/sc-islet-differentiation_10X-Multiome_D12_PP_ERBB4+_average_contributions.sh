...
# Define input files
celltype=D12_PP_ERBB4+
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_PP_ERBB4+/fold_0/chrombpnet/0.5/contributions/D12_PP_ERBB4+.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_PP_ERBB4+/fold_0/chrombpnet/0.5/contributions/D12_PP_ERBB4+.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_PP_ERBB4+/fold_0/chrombpnet/0.5/contributions/D12_PP_ERBB4+.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_PP_ERBB4+/fold_0/chrombpnet/0.5/contributions/D12_PP_ERBB4+.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_PP_ERBB4+/average/contributions
window=400

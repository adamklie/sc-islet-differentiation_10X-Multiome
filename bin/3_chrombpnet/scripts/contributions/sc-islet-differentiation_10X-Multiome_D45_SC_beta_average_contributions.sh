...
# Define input files
celltype=D45_SC_beta
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_SC_beta/fold_0/chrombpnet/0.5/contributions/D45_SC_beta.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_SC_beta/fold_0/chrombpnet/0.5/contributions/D45_SC_beta.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_SC_beta/fold_0/chrombpnet/0.5/contributions/D45_SC_beta.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_SC_beta/fold_0/chrombpnet/0.5/contributions/D45_SC_beta.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D45_SC_beta/average/contributions
window=400

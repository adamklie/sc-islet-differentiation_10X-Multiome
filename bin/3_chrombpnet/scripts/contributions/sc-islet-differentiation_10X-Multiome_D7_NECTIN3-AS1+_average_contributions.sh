...
# Define input files
celltype=D7_NECTIN3-AS1+
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_NECTIN3-AS1+/fold_0/chrombpnet/0.5/contributions/D7_NECTIN3-AS1+.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_NECTIN3-AS1+/fold_0/chrombpnet/0.5/contributions/D7_NECTIN3-AS1+.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_NECTIN3-AS1+/fold_0/chrombpnet/0.5/contributions/D7_NECTIN3-AS1+.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_NECTIN3-AS1+/fold_0/chrombpnet/0.5/contributions/D7_NECTIN3-AS1+.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_NECTIN3-AS1+/average/contributions
window=400

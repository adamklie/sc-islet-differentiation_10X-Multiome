...
# Define input files
celltype=D22_SC_delta+
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D22_SC_delta+/fold_0/chrombpnet/0.5/contributions/D22_SC_delta+.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D22_SC_delta+/fold_0/chrombpnet/0.5/contributions/D22_SC_delta+.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D22_SC_delta+/fold_0/chrombpnet/0.5/contributions/D22_SC_delta+.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D22_SC_delta+/fold_0/chrombpnet/0.5/contributions/D22_SC_delta+.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D22_SC_delta+/average/contributions
window=400

...
# Define input files
celltype=D12_pre_EC_beta
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_pre_EC_beta/fold_0/chrombpnet/0.5/contributions/D12_pre_EC_beta.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_pre_EC_beta/fold_0/chrombpnet/0.5/contributions/D12_pre_EC_beta.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_pre_EC_beta/fold_0/chrombpnet/0.5/contributions/D12_pre_EC_beta.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_pre_EC_beta/fold_0/chrombpnet/0.5/contributions/D12_pre_EC_beta.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_pre_EC_beta/average/contributions
window=400

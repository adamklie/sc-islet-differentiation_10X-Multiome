...
celltype=early_ENP
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/early_ENP/fold_0/chrombpnet/0.5/contributions/early_ENP.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/early_ENP/fold_0/chrombpnet/0.5/contributions/early_ENP.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/early_ENP/fold_0/chrombpnet/0.5/contributions/early_ENP.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/early_ENP/fold_0/chrombpnet/0.5/contributions/early_ENP.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/early_ENP/average/contributions
window=400

...
celltype=ENP_phase1
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/ENP_phase1/fold_0/chrombpnet/0.5/contributions/ENP_phase1.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/ENP_phase1/fold_0/chrombpnet/0.5/contributions/ENP_phase1.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/ENP_phase1/fold_0/chrombpnet/0.5/contributions/ENP_phase1.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/ENP_phase1/fold_0/chrombpnet/0.5/contributions/ENP_phase1.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/3_single_task_models/ENP_phase1/average/contributions
window=400

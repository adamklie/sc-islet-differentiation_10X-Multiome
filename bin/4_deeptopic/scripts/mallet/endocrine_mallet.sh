...
cmd="python /cellar/users/aklie/projects/igvf/single_cell_utilities/pycistopic/run_models.py \
    --input /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_deeptopic/endocrine/objects/sc-islet-differentiation_10X-Multiome_endocrine.pkl \
    --output /cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/results/4_deeptopic/endocrine/models_mallet/topic_${topic} \
    --n_topics $topic \
    --method mallet \
    --n_cpu 8 \
    --n_iter 150 \

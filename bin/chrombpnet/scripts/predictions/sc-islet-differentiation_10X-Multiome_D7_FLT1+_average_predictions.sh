...
celltype=D7_FLT1+
bias_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_FLT1+/fold_0/chrombpnet/0.5/predictions/D7_FLT1+_bias.bw
)
chrombpnet_nobias_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_FLT1+/fold_0/chrombpnet/0.5/predictions/D7_FLT1+_chrombpnet_nobias.bw
)
chrombpnet_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_FLT1+/fold_0/chrombpnet/0.5/predictions/D7_FLT1+_chrombpnet.bw
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D7_FLT1+/average/predictions

...
bias_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D9_LINC01924+/fold_0/chrombpnet/0.5/predictions/D9_LINC01924+_bias.bw
)
chrombpnet_nobias_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D9_LINC01924+/fold_0/chrombpnet/0.5/predictions/D9_LINC01924+_chrombpnet_nobias.bw
)
chrombpnet_preds=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D9_LINC01924+/fold_0/chrombpnet/0.5/predictions/D9_LINC01924+_chrombpnet.bw
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D9_LINC01924+/average/predictions

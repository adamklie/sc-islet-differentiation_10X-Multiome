...
# Define input files
celltype=D12_ENP_ARX+
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_ARX+/fold_0/chrombpnet/0.5/contributions/D12_ENP_ARX+.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_ARX+/fold_0/chrombpnet/0.5/contributions/D12_ENP_ARX+.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_ARX+/fold_0/chrombpnet/0.5/contributions/D12_ENP_ARX+.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_ARX+/fold_0/chrombpnet/0.5/contributions/D12_ENP_ARX+.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_ARX+/average/contributions
window=400

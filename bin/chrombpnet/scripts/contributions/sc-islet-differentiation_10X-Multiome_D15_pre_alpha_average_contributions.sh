...
# Define input files
celltype=D15_pre_alpha
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D15_pre_alpha/fold_0/chrombpnet/0.5/contributions/D15_pre_alpha.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D15_pre_alpha/fold_0/chrombpnet/0.5/contributions/D15_pre_alpha.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D15_pre_alpha/fold_0/chrombpnet/0.5/contributions/D15_pre_alpha.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D15_pre_alpha/fold_0/chrombpnet/0.5/contributions/D15_pre_alpha.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D15_pre_alpha/average/contributions
window=400

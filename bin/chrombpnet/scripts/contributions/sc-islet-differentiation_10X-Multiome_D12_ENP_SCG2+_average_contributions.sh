...
# Define input files
celltype=D12_ENP_SCG2+
counts=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_SCG2+/fold_0/chrombpnet/0.5/contributions/D12_ENP_SCG2+.counts_scores.bw
)
profile=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_SCG2+/fold_0/chrombpnet/0.5/contributions/D12_ENP_SCG2+.profile_scores.bw
)
counts_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_SCG2+/fold_0/chrombpnet/0.5/contributions/D12_ENP_SCG2+.counts_scores.h5
)
profile_h5=(
	/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_SCG2+/fold_0/chrombpnet/0.5/contributions/D12_ENP_SCG2+.profile_scores.h5
)
output_dir=/cellar/users/aklie/data/datasets/sc-islet-differentiation_10X-Multiome/models/D12_ENP_SCG2+/average/contributions
window=400
